...
app.use("/api/lead/webhook/meta", express.json({
    verify: (req, res, buf) => {
        req.rawBody = buf;
    }
}));
...
app.get("/", (req, res) => {
    res.status(200).json({
        success: true,
        message: "7Central Backend is running 🚀"
    });
});
...
app.use("/api/employee-increment", require("./routes/employeeIncrementRoutes.js"));
app.use("/api/employee-leave", require("./routes/employeeLeaveRoutes.js"));
