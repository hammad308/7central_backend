...
const PREFIX_EMPLOYEE_TASK_AUTOINCREMENTID = `TSK-${APP_SHORT_NAME}-`;
...
const PREFIX_EVENT_AUTOINCREMENTID = `EVT-${APP_SHORT_NAME}-`;
const PREFIX_LEAD_AUTOINCREMENTID = `LEAD-${APP_SHORT_NAME}-`;
...
module.exports = {
  ...
  PREFIX_EMPLOYEE_TASK_AUTOINCREMENTID,
  PREFIX_EVENT_AUTOINCREMENTID,
  PREFIX_LEAD_AUTOINCREMENTID
};