...
const sendForgotPasswordEmail = async (otp , user) => {
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>${APP_NAME} hesabınızın şifresini sıfırlamak için bir talepte bulundunuz. OTP kodunuz:</p>
                    <span class="otp">
                        ${otp}
                    </span>
                    <p>Erişiminizi yeniden kazanmak için bu kodu girin. Lütfen bu kodun kısa bir süre için geçerli olduğunu unutmayın.</p>
    ...
    const mailOptions = {
        from:`"${APP_NAME} Password Recovery" <${process.env.EMAIL_USER}>` ,
        to: user.email,
